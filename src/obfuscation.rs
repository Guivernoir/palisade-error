//! Error code obfuscation for ultra-paranoid deployments.
//!
...
pub fn obfuscate_code(base: ErrorCode) -> ErrorCode {
    ...
    ErrorCode::new(base.namespace(), new_code, base.category())
}
...
mod tests {
    ...
    fn obfuscation_stays_within_namespace() {
        let base = ErrorCode::new("TEST", 150, OperationCategory::Configuration);
        ...
        for salt in 0..8 {
            ...
            assert_eq!(obfuscated.namespace(), "TEST");
    ...
    fn different_salts_produce_different_codes() {
        let base = ErrorCode::new("TEST", 100, OperationCategory::Configuration);
    ...
    fn obfuscation_at_namespace_boundary() {
        ...
        let base_low = ErrorCode::new("TEST", 100, OperationCategory::Configuration);
        let base_high = ErrorCode::new("TEST", 199, OperationCategory::Configuration);
    ...
    fn wrapping_behavior() {
        ...
        let base = ErrorCode::new("TEST", 195, OperationCategory::Configuration);
        init_session_salt(7);
        let obfuscated = obfuscate_code(base);
    ...
    fn obfuscation_formatting() {
        ...
        assert_eq!(obfuscated.to_string(), "E-TEST-103");
    }
    ...
    fn multiple_namespaces() {
        ...
        let cfg = ErrorCode::new("CFG", 100, OperationCategory::Configuration);
        let io = ErrorCode::new("IO", 800, OperationCategory::IO);
